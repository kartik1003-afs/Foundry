...
# @app.post("/report")
# def report_item(payload: ItemPayload, image_url: str):
#     try:
#         img_emb = encode_image_url(image_url)
#     except ValueError as e:
#         return {"error": str(e)}

#     text_input = f"a photo of {payload.description} at {payload.location}"
...
#         add_vector(final_emb, payload.item_id)
...
#     elif payload.report_type == "found":
